...
- Use Geist Sans for interface and display text, Geist Pixel Square (`font-pixel`) for the brand wordmark and page headings, and DM Mono for code, technical values, and monospaced text.
